...
<NavEras navigateWithinMap={false} activeEraID={$page.params.era} />
<div
	id="story-container"
	class={`era-${$page.params.era}`}
...
>
	<div id="story-narrative">
		...
		{#if data.chapter.headlineImage}
			<figure class="figure">
				<img
					src={data.chapter.headlineImage.url}
					class="figure-img"
					alt={data.chapter.headlineImage.title}
				/>
		...
		<div id="story-footer-navigation">
			<div id="story-footer-navigation-back">
				<a href={base + (data.lastChapter ? data.lastChapter.link : `/#/view/${data.eraView}`)}>
			...
			<div id="story-footer-navigation-next">
				<a href={base + (data.nextChapter ? data.nextChapter.link : data.nextEra ? `/#/view/${data.nextEra.view}` : '/')}>
